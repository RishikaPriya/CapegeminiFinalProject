...
//		then redirect web-client to resource named as "categories.html"
		...
		if(request.getParameter("continue")!=null && request.getParameter("continue").equals("Shop More?")){
...
//		Add mapping for resource "displayDetails" in WEB.XML
		if(request.getParameter("checkout")!=null && request.getParameter("checkout").equals("Check Out")){
